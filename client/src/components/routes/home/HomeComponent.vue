    ...
    <div id="accordion" class="accordion mt-2">
      ...
      <div class="accordion-item">
        ...
        <div id="reports" class="accordion-collapse collapse">
          <div class="accordion-body">
            ...
            находятся список отчётов уже обработанных карт, на которых 
            найдены аномалии. Здесь можно открыть карту изображения, к которому
      ...
      <div class="accordion-item">
        ...
        <div id="reports-view" class="accordion-collapse collapse">
          <div class="accordion-body">
            В просмотре отчёта отображаются данные по всем найденным на изображении аномалиям.
            Там же можно открыть на просмотр одну отдельную аномалию или отобразить её на карте.
          </div>
        </div>
      </div>
